...
lolcat
toilet -f standard -F gay “DEATH_FLASH“
echo ""
echo "\033[34;1m[$]\033[36;1m============================\033[34;1m[$]"
echo "\033[32;1mAuthor : Mr.Rukan022"
echo "\033[35;1mversion Tools: 1.0"
echo "\033[35;1mTeam : -"
echo "\033[33;1mKontak Me :  083189179628"
echo "\033[31;1mPlease For Subcribe Youtube: https://youtube.com/channel/UCCeGyzXjj9NSygM5SyswJgQ"
echo "\033[34;1m[$]\033[36;1m============================\033[34;1m[$]"
echo ""
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "DEATH_FLASH:" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "M.r Rukan022" | lolcat
php tp.php
fi
...
then
clear
toilet -f slant --gay "Mr.Rukan022"
php kfc.php
fi
...
then
clear
toilet -f mono12 -F gay "Mr.Rukan022"
php phd.php
fi
...
then
clear
toilet -f slant -F gay "M.r Rukan022" 
...
then
clear
toilet -f mono12 -F gay "M.r Rukan022" 
apt upgrade
apt install python2
apt install git
...
sleep 1
echo "\033[32;1m================================By M.r Rukan022================================"
sleep 1
echo ""
echo ""
ping 8.8.8.8 
...
echo "\033[32;1mauthor: M.r Rukan022"
...
then
clear
toilet -f slant --gay "M.r Rukan022"
apt update && apt upgrade
apt install git
apt install clang
...
then
clear
toilet -f big -F gay "M.r Rukan022 " | lolcat
sleep 1
...
then
clear
toilet -f big -F gay " M.r Rukan022 "
sleep 1
apt update && apt upgrade
apt install wget
mkdir ngrok
...
then
clear
toilet -f big -F gay "Mr.Rukan022"
sleep 1
apt update 
apt upgrade
apt install python2
